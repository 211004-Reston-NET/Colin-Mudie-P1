    ...
    public partial class InitialIdentityDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StoreFront", x => x.StoreFrontId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LineItems_StoreFront_StoreFrontId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Order_StoreFront_StoreFrontId",
                        column: x => x.StoreFrontId,
                        principalTable: "StoreFront",
                        principalColumn: "StoreFrontId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LineItemsOrder_LineItems_LineItemsId",
                        column: x => x.LineItemsId,
                        principalTable: "LineItems",
                        principalColumn: "LineItemsId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LineItemsOrder_Order_OrderId",
                        column: x => x.OrderId,
